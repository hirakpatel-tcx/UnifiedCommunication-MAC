...
export const LoginScreen: React.FC<LoginScreenProps> = ({
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen w-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 overflow-hidden select-none px-4 py-8 transition-colors duration-200">
      ...
      <header className="titlebar-drag fixed top-0 inset-x-0 h-12 flex items-center justify-between px-4 z-30">
        ...
        <div className="no-drag flex items-center gap-2">
          <button
            ...
            className="p-2 rounded-xl text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-200/60 dark:hover:bg-zinc-800/80 transition-colors cursor-pointer"
          >
      ...
      <div className="w-full max-w-md z-10 animate-popIn">
        ...
        <div className="text-center mb-6">
          <div className="relative inline-flex items-center justify-center mb-3">
            <div className="w-16 h-16 rounded-2xl bg-brand-600 text-white flex items-center justify-center shadow-xl shadow-brand-600/25 ring-1 ring-white/20">
              <PhoneCall className="w-8 h-8 drop-shadow-md" />
            </div>
            <div className="absolute -bottom-1 -right-1 p-1 bg-emerald-500 text-white rounded-full ring-2 ring-white dark:ring-zinc-950">
        ...
        {/* Form Container */}
        <div className="glass-panel rounded-3xl p-6 sm:p-7 shadow-2xl border border-zinc-200/80 dark:border-zinc-800/90 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl">
          {/* Error Banner */}
          {errorMessage && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="glass-input w-full pl-9 pr-3 py-2.5 rounded-xl text-sm font-medium focus:outline-none placeholder:text-zinc-400"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  placeholder="••••••••••••"
                  className="glass-input w-full pl-9 pr-10 py-2.5 rounded-xl text-sm font-medium focus:outline-none placeholder:text-zinc-400"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2 text-xs text-zinc-600 dark:text-zinc-400 cursor-pointer">
                <input
                  ...
                  className="rounded border-zinc-300 text-brand-600 focus:ring-brand-500/30 w-3.5 h-3.5 cursor-pointer"
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="tactile-btn w-full mt-2 py-3 px-4 rounded-xl bg-brand-600 hover:bg-brand-500 active:scale-[0.98] text-white font-semibold text-sm shadow-lg shadow-brand-600/30 flex items-center justify-center gap-2 transition-all disabled:opacity-60 cursor-pointer"
            >
              {isLoading ? (
                <>
        ...
        <div className="mt-6 flex items-center justify-center gap-4 text-[11px] text-zinc-500 dark:text-zinc-400">
