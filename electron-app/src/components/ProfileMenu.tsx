...
export const ProfileMenu: React.FC<ProfileMenuProps> = ({
  ...
  return (
    <div
      ref={menuRef}
      className="absolute top-12 right-3 w-80 rounded-2xl bg-white dark:bg-[#1E2330] border border-slate-200 dark:border-slate-750 shadow-2xl z-50 overflow-hidden text-slate-800 dark:text-slate-100 select-none animate-fadeIn transition-colors duration-150"
    >
      {/* Top Section: Avatar & User Identity */}
      <div className="p-4 flex items-center gap-3.5 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30">
        <div className="relative shrink-0">
          ...
          {/* Presence Ring */}
          <span
            className={`absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 rounded-full border-2 border-white dark:border-[#1E2330] ${isRegistered ? presenceLabels[presence].color : 'bg-slate-400'
              }`}
          />
        </div>
      ...
      <div className="px-4 py-2.5 bg-slate-50/80 dark:bg-slate-900/40 border-b border-slate-200 dark:border-slate-800 flex items-center gap-2.5">
      ...
      <div className="border-b border-slate-200 dark:border-slate-800 py-1">
        <div className="px-4 pt-2 pb-1 text-xs text-slate-500 dark:text-slate-400 font-medium">
          Share status
        </div>
        ...
        <div className="px-1.5 pb-1">
          <button
            ...
            className="w-full flex items-center justify-between px-2.5 py-2 rounded-xl text-sm font-medium hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors cursor-pointer"
          >
            <div className="flex items-center gap-2.5">
              <span className={`w-3 h-3 rounded-full ${currentPresenceInfo.color} ring-2 ring-white dark:ring-[#1E2330] shrink-0`} />
