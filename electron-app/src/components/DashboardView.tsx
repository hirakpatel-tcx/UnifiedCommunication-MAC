...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="flex flex-col flex-1 w-full min-h-0 mx-auto space-y-3 sm:space-y-4 animate-fadeIn">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-brand-700 p-3.5 sm:p-4 md:p-5 text-white shadow-md shadow-brand-700/15 shrink-0">
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="space-y-0.5">
            ...
            <p className="text-brand-100/85 text-[11px] sm:text-xs">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white text-brand-700 hover:bg-brand-50 active:scale-95 font-semibold text-xs transition-all shadow-sm cursor-pointer"
            >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-3 shrink-0">
        <div className="p-3 sm:p-3.5 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 shadow-2xs flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 font-medium truncate">Total Calls</p>
            <h3 className="text-lg sm:text-xl font-bold text-zinc-900 dark:text-zinc-100 leading-none">{totalCalls}</h3>
          </div>
        </div>
        ...
        <div className="p-3 sm:p-3.5 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 shadow-2xs flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 font-medium truncate">Connected</p>
            <h3 className="text-lg sm:text-xl font-bold text-zinc-900 dark:text-zinc-100 leading-none">{connectedCalls}</h3>
          </div>
        </div>
        ...
        <div className="p-3 sm:p-3.5 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 shadow-2xs flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[11px] text-zinc-500 dark:text-zinc-400 font-medium truncate">Missed Calls</p>
            <h3 className="text-lg sm:text-xl font-bold text-zinc-900 dark:text-zinc-100 leading-none">{missedCalls}</h3>
          </div>
        </div>
        ...
        <button
          ...
          className="group p-3 sm:p-3.5 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 shadow-2xs flex items-center justify-between gap-2 hover:border-amber-400/60 dark:hover:border-amber-500/40 hover:shadow-xs transition-all cursor-pointer text-left"
        >
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-[11px] text-zinc-500 dark:text-zinc-400 font-medium truncate">Voicemails</p>
              <h3 className="text-lg sm:text-xl font-bold text-zinc-900 dark:text-zinc-100 leading-none">
                {user.voicemail_boxes?.length || 0}
              </h3>
            </div>
          </div>
          <ArrowUpRight className="w-3.5 h-3.5 text-zinc-400 group-hover:text-amber-500 group-hover:tranzinc-x-0.5 group-hover:-tranzinc-y-0.5 transition-all shrink-0" />
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 flex-1 items-stretch min-h-0">
        ...
        <div className="p-3.5 sm:p-4 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 shadow-2xs flex flex-col justify-between">
          <div>
            ...
            {history.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-8 text-center text-zinc-400">
                <Clock className="w-8 h-8 stroke-[1.5] text-zinc-300 dark:text-zinc-700 mb-1.5" />
                <p className="text-xs font-medium">No recent calls recorded yet</p>
                <p className="text-[10px] text-zinc-400 mt-0.5">Calls will appear here automatically</p>
              </div>
            ) : (
              <div className="divide-y divide-zinc-100 dark:divide-zinc-800/80">
                {history.slice(0, 5).map((record) => {
                  ...
                  return (
                    <div
                      key={record.id}
                      className="py-1.5 sm:py-2 flex items-center justify-between text-xs hover:bg-zinc-50 dark:hover:bg-zinc-800/50 px-1.5 rounded-lg transition-colors"
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0">
                          <p className="font-semibold text-zinc-800 dark:text-zinc-200 font-mono text-xs truncate">
                            {cleaned}
                          </p>
                      ...
                      <button
                        ...
                        title="Redial"
                        className="p-1.5 rounded-lg text-zinc-400 hover:text-brand-600 hover:bg-brand-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
                      >
          ...
          <div className="pt-2.5 border-t border-zinc-100 dark:border-zinc-800 mt-2">
            <button
              onClick={() => onNavigateTab('keypad')}
              className="w-full py-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-xs font-semibold text-zinc-700 dark:text-zinc-200 transition-colors cursor-pointer flex items-center justify-center gap-1.5"
            >
          ...
          <div>
            ...
            <div className="relative mb-2">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 text-xs rounded-lg bg-zinc-50 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-1.5 focus:ring-brand-500"
              />
            </div>

            {filteredContacts.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-8 text-center text-zinc-400">
                <Users className="w-8 h-8 stroke-[1.5] text-zinc-300 dark:text-zinc-700 mb-1.5" />
              ...
              <div className="divide-y divide-zinc-100 dark:divide-zinc-800/80">
                {filteredContacts.slice(0, 5).map((c) => (
                  <div
                    key={c.id}
                    className="py-1.5 sm:py-2 flex items-center justify-between hover:bg-zinc-50 dark:hover:bg-zinc-800/50 px-1.5 rounded-lg transition-colors"
                  >
                    ...
                    <button
                      ...
                      title={`Call ${c.name}`}
                      className="p-1.5 rounded-lg text-zinc-400 hover:text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-colors cursor-pointer shrink-0"
                    >
